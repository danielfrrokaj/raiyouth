                            ...
                            VStack(spacing: 12) {
                                HStack(spacing: Theme.Spacing.md) {
                                    ...
                                    VStack(alignment: .leading, spacing: 3) {
                                        HStack {
                                            Text(chat.name)
                                                .font(.system(size: 14, weight: chat.unread ? .bold : .semibold))
                                                .foregroundColor(.white)
                                            Spacer()
                                            Text(chat.time)
                                                .font(.system(size: 11))
                                    ...
                                    // Instagram quick camera button on the right
                                    if !chat.unread {
                                ...
                                // Revolut-style Interactive Split Card
